...
public class ReceivedRequestsController implements Initializable {
    ...
    public static void show() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(socialnetwork.gui.UserController.class.getResource("received-requests-view.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            Stage stage = new Stage();
            stage.setTitle("Requests Received");
    ...
    private void setTable() throws Exception {
        ...
        ObservableList<FriendshipWithStatus> modelUser = FXCollections.observableArrayList(service.pendingFriendships());
