...
public class FriendshipsController implements Initializable {
    ...
    public static void show() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(socialnetwork.gui.UserController.class.getResource("friendships-view.fxml"));
    ...
    private void setTable() throws Exception {
        ...
        ObservableList<FriendshipWithStatus> modelUser = FXCollections.observableArrayList(service.acceptedFriendships());
